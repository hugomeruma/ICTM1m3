...
?>
    ...
    <div class="container">
        <form method="post" action="">
            ...
            <!--                <div class="col-sm-10">-->
            <!--                    <input class="form-control" type="text" name="nummer" readonly="-->
            <? //= $gegevens["id"] ?><!--"/>-->
            <!--                </div>-->
            <!--            </div>-->
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <input class="form-control" type="text" name="voornaam"
                           value="<?php print($gegevens["voornaam"]); ?>" required/>
                </div>
            </div>
            <div class="form-group row">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <input class="form-control" type="text" name="achternaam"
                           value="<?php print($gegevens["achternaam"]); ?>"
                           required/>
                </div>
            </div>
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <input class="form-control" type="text" name="email" value="<?php print($gegevens["email"]); ?>"
                           required/>
                </div>
            </div>
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <input class="form-control" type="text" name="woonplaats"
                           value="<?php print($gegevens["woonplaats"]); ?>"
                           required/>
                </div>
            </div>
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <input class="form-control" type="text" name="postcode"
                           value="<?php print($gegevens["postcode"]); ?>"
                           required/>
                </div>
            </div>
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <input class="form-control" type="text" name="huisnummer"
                           value="<?php print($gegevens["huisnummer"]); ?>"
                           required/>
                </div>
            </div>
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <input class="form-control" type="text" name="straatnaam"
                           value="<?php print($gegevens["straatnaam"]); ?>"
                           required/>
                </div>
            </div>
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <input class="form-control" type="text" name="telefoonnr"
                           value="<?php print($gegevens["telefoonnr"]); ?>"/>
                </div>
            </div>
            <div class="form-group row">
